...
export default function AboutPage() {
  const timeline = [
    ...
    },
    {
      ...
      description: 'أصبحنا أحد أكبر وكلاء تاتا في مصر من حيث المبيعات',
      icon: TrendingUp
    },
    {
      year: '2015',
      title: 'التميز في الخدمة',
      description: 'الحصول على جائزة أفضل وكيل خدمة لعملاء تاتا',
      icon: Award
    },
    {
      year: '2020',
  ...
  const values = [
    ...
    },
    {
      icon: Heart,
      title: 'النزاهة',
      description: 'نتعامل بشفافية ونزاهة في جميع تعاملاتنا مع العملاء'
    },
    {
      icon: Target,
      title: 'التميز',
  ...
  const stats = [
    ...
    { number: '50K+', label: 'سيارة مباعة', icon: Car },
    { number: '15+', label: 'معرض وخدمة', icon: MapPin },
    { number: '100K+', label: 'عميل راضٍ', icon: Users }
  ]
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'صيانة وإصلاح احترافي باستخدام قطع غيار أصلية',
      icon: Wrench
    },
    {
      title: 'تمويل سيارات',
      description: 'حلول تمويلية ميسرة بشروط مرنة',
      icon: TrendingUp
    },
    {
      title: 'استشارات مجانية',
      description: 'فريق من الخبراء لمساعدتك في اختيار السيارة المناسبة',
      icon: Users
    }
  ]
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <section className="mb-16">
          <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-2xl p-12">
            <div className="text-center mb-8">
              ...
              <p className="text-blue-100">إنجازاتنا على مدار 25 عاماً من الخبرة</p>
            </div>
        ...
        <section className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">نقدم مجموعة شاملة من الخدمات لتلبية جميع احتياجاتكم</p>
          </div>
