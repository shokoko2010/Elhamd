  ...
  useEffect(() => {
    ...
    const mockVehicles: Vehicle[] = [
      ...
      },
      {
        ...
        mileage: 0,
        color: 'Silver',
        description: 'Stylish sedan with premium features',
        status: 'AVAILABLE',
      ...
      },
      {
        ...
        mileage: 0,
        color: 'Green',
        description: 'Premium hatchback with advanced safety',
        status: 'AVAILABLE',
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Select value={filters.fuelType} onValueChange={(value) => setFilters({...filters, fuelType: value})}>
                    ...
                    <SelectContent>
                      <SelectItem value="">جميع أنواع الوقود</SelectItem>
                ...
                <div>
                  ...
                  <Select value={filters.transmission} onValueChange={(value) => setFilters({...filters, transmission: value})}>
                    ...
                    <SelectContent>
                      <SelectItem value="">جميع أنواع ناقل الحركة</SelectItem>
