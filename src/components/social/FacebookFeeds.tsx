...
export function FacebookFeeds({ pageUrl, videoUrl }: FacebookFeedsProps) {
    ...
    if (videoUrl && typeof videoUrl === 'string') {
      ...
      if (trimmed.length > 0) {
        ...
        try {
          ...
          // ignore parsing errors and use default value
        }
      }
    }
  ...
  const encodedVideoUrl = useMemo(() => encodeURIComponent(normalizedVideoUrl), [normalizedVideoUrl])
  ...
  const videoSrc = useMemo(
    () =>
      `https://www.facebook.com/plugins/video.php?href=${encodedVideoUrl}&show_text=false&width=500&height=700&adapt_container_width=true&autoplay=false`,
    [encodedVideoUrl]
  )

  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6" dir="rtl">
      <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm" dir="rtl">
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-inner border border-gray-100">
            ...
            {videosError ? (
              <div className="p-8 text-center text-gray-600 space-y-3">
                ...
                <p className="text-sm">تحقق من رابط الفيديو أو الريلز وأعد المحاولة لاحقًا.</p>
                <a
